...
<head>
    ...
    <title>Rates Management — COWASCO Waters</title>
...
<main class="page">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Select a module to configure system pricing and calculation logic</p>
        </div>
    </div>

    <div class="action-grid">
        
        <a href="water_meter.php" class="action-card">
            <div class="ac-icon">
            ...
            <div>
                <div class="ac-title">Water Bill Rates</div>
                <div class="ac-desc">Configure tiered water consumption ranges, flat fees, and per-cubic metrics.</div>
            </div>
        </a>

        <a href="rate_codes.php" class="action-card">
            <div class="ac-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div>
                <div class="ac-title">Rate Codes</div>
                <div class="ac-desc">Manage standard billing codes, fixed amounts, and ledger mappings.</div>
            </div>
        </a>
